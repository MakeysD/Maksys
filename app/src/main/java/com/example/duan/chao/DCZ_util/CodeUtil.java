...
public class CodeUtil {
    ...
    public static void pushcode(Context context){
        ...
        MyApplication.map.put("8088",context.getString(R.string.code49));
        ...
        MyApplication.map.put("10538",context.getString(R.string.code50));
        MyApplication.map.put("80001",context.getString(R.string.code51));
        MyApplication.map.put("80008",context.getString(R.string.code52));
        MyApplication.map.put("10519",context.getString(R.string.code53));
        MyApplication.map.put("10539",context.getString(R.string.code54));
        MyApplication.map.put("10540",context.getString(R.string.code55));
        MyApplication.map.put("10541",context.getString(R.string.code56));
        MyApplication.map.put("10542",context.getString(R.string.code57));
        MyApplication.map.put("10543",context.getString(R.string.code58));
        MyApplication.map.put("10544",context.getString(R.string.code59));
        ...
        MyApplication.map.put("2003",context.getString(R.string.data2003));
        MyApplication.map.put("1009",context.getString(R.string.data1009));
        MyApplication.map.put("2000",context.getString(R.string.data2000));
