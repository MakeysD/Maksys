...
public class LookPayPassword2Activity extends BaseActivity {
    private LookPayPassword2Activity INSTANCE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_look_pay_password2);
        INSTANCE=this;
    ...
    public void getSms(){
        ...
        dialog.show();
        HttpServiceClient.getInstance().sendsms(phone.getText().toString()+"@qeveworld.com","6",null).enqueue(new Callback<LoginOkBean>() {
            @Override
