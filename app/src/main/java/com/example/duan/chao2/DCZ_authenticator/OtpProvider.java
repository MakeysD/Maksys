...
import com.example.duan.chao2.DCZ_authenticator.PasscodeGenerator.Signer;
...
public class OtpProvider implements OtpSource {
  ...
  private String getCurrentCode(String username, byte[] challenge) throws OtpSourceException {
    ...
    if (type == OtpType.TOTP) {
      ...
      otp_state = mTotpCounter.getValueAtTime(Utilities.millisToSeconds(mTotpClock.currentTimeMillis()- MyApplication.offset));
