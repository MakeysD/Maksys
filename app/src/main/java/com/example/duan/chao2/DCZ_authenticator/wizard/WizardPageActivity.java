...
package com.example.duan.chao2.DCZ_authenticator.wizard;
...
import com.example.duan.chao2.DCZ_authenticator.testability.TestableActivity;
...
public class WizardPageActivity<WizardState extends Serializable> extends TestableActivity {
   ...
   *
   * @see #showInlineProgress(View.OnClickListener)
   */
